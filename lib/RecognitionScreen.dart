...
class _HomePageState extends State<RecognitionScreen> {
  ...
  _fetchRegisteredImage(String imageName) async {
    try {
      // Replace 'RegisterdImages' with the actual path of your images in Firebase Storage
      Reference reference =
          FirebaseStorage.instance.ref().child('RegisterdImages/$imageName.jpg');
              ...
              ? Container(
                  ...
                  child: FittedBox(
                    child: SizedBox(
                      ...
                      child: CustomPaint(
                        painter:
                            FacePainter(facesList: recognitions, imageFile: _registeredImage),
                      ),
                    ),
                  ),
                )
